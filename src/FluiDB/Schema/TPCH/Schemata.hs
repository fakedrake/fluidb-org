...
nation :: GenSchema
nation = [(CppNat,"n_nationkey"),
          (strType 25,"n_name"),
          (CppNat,"n_regionkey"),
          (strType 152,"n_comment")]

orders :: GenSchema
orders = [(CppNat,"o_orderkey"),
          (CppNat,"o_custkey"),
...
region :: GenSchema
region = [(CppNat,"r_regionkey"),
          (strType 25,"r_name"),
          (strType 152,"r_comment")]

supplier :: GenSchema
supplier = [(CppNat,"s_suppkey"),
            (strType 25,"s_name"),
