...
class Record4 {
 public:
  Record4(double __sym__0__6444796841181455837) : sym__0__6444796841181455837(__sym__0__6444796841181455837)
  {
  }
  Record4() 
  {
...
class CallableClass2 {
 public:
  bool operator()(const Record1& record0) {
    return ((((4 <= record0.sym__0___45_6984436199184448105) && (record0.sym__0___45_6984436199184448105 <= 6)) && (26 <= record0.sym__0__3673553332159180977)) && (record0.sym__0__3673553332159180977 <= 35));
  }
...
class CallableClass7 {
 public:
  Record4 operator()(const Record6& record3) {
    return Record4(vAggrSum5(record3.sym__0__8532410199738998392 * record3.sym__0___45_2513573066306319392));
  }
...
int main() {
  ...
  deleteFile("/tmp/fluidb_store/data24.dat");
  // Delete: (S 
  //   (P2 
  //     PAnd 
  //     (P2 PAnd 
  ...
  {
    auto operation = mkSelect<CallableClass2>(Just<const std::string>("/tmp/fluidb_store/data12.dat"), Just<const std::string>("/tmp/fluidb_store/data13.dat"), "/tmp/fluidb_store/data8.dat");
    operation.run();
  ...
  std::cout << "ForwardTrigger: (Just \n  (Right \n    [\n     QGroup \n        [\n         (\n           ESym \"revenue\",\n           E0 \n              (NAggr \n                AggrSum \n                (E2 EMul \n                    (E0 (ESym \"lo_extendedprice\")) \n                    (E0 (ESym \"lo_discount\"))))\n          )\n        ] \n        []\n    ]))" << std::endl;
  {
    auto operation = mkTotalAggregation<CallableClass7>(Just<const std::string>("/tmp/fluidb_store/data14.dat"), Just<const std::string>("/tmp/fluidb_store/data12.dat"), "/tmp/fluidb_store/data12.dat");
    operation.run();
    operation.print_output(10);
  }
  report_counters();
