...
git push
ssh christosp@yaguajay bash -c "'cd /home/christosp/Projects/fluidb-org && git pull && rm -f /tmp/branches.zip && ./branches.sh && zip -r /tmp/branches.zip /tmp/benchmark.out.bench_branches'"
